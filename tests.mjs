...
if (catalog.records.length !== 151) throw new Error(`Expected 152 records, found ${catalog.records.length}`);
if (new Set(catalog.records.map(record => record.mos)).size !== 151) throw new Error("MOS codes must be unique");
